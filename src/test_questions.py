...
'''
q3b = '''
3б Следить за состоянием, развитием растениий.
'''

q4a = '''
4а Обрабатывать материалы (дерево, ткань, пластмассу, металл и т.п.).
'''
q4b = '''
...
'''
q11b = '''
11б Конструировать, проектировать новые виды промышленных изделий (машины или одежду, дома, продукты питания и т.п.).
'''

q12a = '''
12а Разбирать споры, ссоры между людьми, убеждать, разъяснять поощрять, наказывать.
'''
q12b = '''
...
q14a = '''
14а Обсуждать, налаживать медицинские приборы, аппараты.
'''
q14b = '''
...
'''
q19b = '''
19б Заниматься черчением, копированием чертежей, карт.
'''
...
'''
q20b = '''
20б Работать на клавишных машинах.
'''
